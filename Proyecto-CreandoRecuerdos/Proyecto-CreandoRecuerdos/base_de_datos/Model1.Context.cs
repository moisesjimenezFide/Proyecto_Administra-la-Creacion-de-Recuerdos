...
namespace Proyecto_CreandoRecuerdos.base_de_datos
{
    ...
    public partial class BD_CREANDO_RECUERDOSEntities : DbContext
    {
        public BD_CREANDO_RECUERDOSEntities()
            : base("name=BD_CREANDO_RECUERDOSEntities2")
        {
        }
        ...
        public virtual DbSet<costos_receta_materias_primas> costos_receta_materias_primas { get; set; }
        public virtual DbSet<costos_receta_productos_preparados> costos_receta_productos_preparados { get; set; }
        public virtual DbSet<precios_empaques_decorativos> precios_empaques_decorativos { get; set; }
        public virtual DbSet<precios_implementos_utilizados> precios_implementos_utilizados { get; set; }
        public virtual DbSet<precios_suministro_utilizados> precios_suministro_utilizados { get; set; }
